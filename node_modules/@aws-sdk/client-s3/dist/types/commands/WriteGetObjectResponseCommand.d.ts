...
export declare type WriteGetObjectResponseCommandInput = Omit<WriteGetObjectResponseRequest, "Body"> & {
    Body?: WriteGetObjectResponseRequest["Body"] | string | Uint8Array | Buffer;
};
export declare type WriteGetObjectResponseCommandOutput = __MetadataBearer;
/**
